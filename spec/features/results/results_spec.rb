...
describe "Logged in User" do
  before(:each) do
    ...
    @house_bill_vote1 = create(:house_bill_vote, house_roll_call: 153, house_offset: 0, bill_id: @bill_1.id)
    @house_bill_vote2 = create(:house_bill_vote, house_roll_call: 152, house_offset: 20, bill_id: @bill_2.id)
