...
RSpec.describe "on the rep or senator show page" do
  describe "It shows a buton to favorite and remove favorite" do
    ...
    it "as a logged in user it shows the add favorites button" do
      user = create(:user)
    ...
    it "allows the logged in user to add representative to favorites" do
      user = create(:user)
    ...
    it "allows a logged in user to remove from representative favorites" do
      user = create(:user)
    ...
    it "allows a logged in user to add senator from favorites" do
      user = create(:user)
    ...
    it "allows a logged in user to remove senator from favorites" do
      user = create(:user)
    ...
    it "shows a message for a non logged in user to sign up" do
      visit "/senators/#{@senator1.id}"
